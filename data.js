...
window.DEFAULT_DATA = {
  ...
  meta: {
    ...
    principles: [
      ...
      'Лаборатория = дека-билдинг вне катки: игрок сам решает, какие моды попадут в пул.',
    ...
    buildings: [
      ...
      { id: 'lab', name: 'Лаборатория', desc: 'Исследование модов → пул катки.', levels: [
        { cost: { scrap: 0 }, unlock: 'Стартовый пул: common + 6 uncommon.' },
        { cost: { scrap: 1200, essence: 80 }, unlock: 'Rare. Исключить 3 мода из пула.' },
        { cost: { scrap: 3000, essence: 300 }, unlock: 'Epic. 2 параллельных исследования.' },
        { cost: { scrap: 7000, essence: 900, core: 1 }, unlock: 'Legendary. Стартовый common на выбор.' } ] },
